...
Texture::Texture(IO::ImageRGB &rgbImg) : Texture(rgbImg.GetWidth(), rgbImg.GetHeight(), GL_RGB, GL_RGB,
                                                 GL_UNSIGNED_BYTE)
{
}

Texture::Texture(IO::ImageBGRA &bgraImg) : Texture(bgraImg.GetWidth(), bgraImg.GetHeight(), GL_RGB, GL_BGRA,
                                                   GL_UNSIGNED_BYTE)
{
}
