...
Program::Program(LogLevel logLevel, LogChannel logChannels)
{
...
void Program::InitializeSDL()
{
	...
	LogInfo(LogChannel::ALL, "SDL version: %d.%d.%d.", sdlVersion.major, sdlVersion.minor, sdlVersion.patch);
}
...
void Program::InitializeOpenGL()
{
	...
	LogInfo(LogChannel::GRAPHICS, "OpenGL version: %s", glGetString(GL_VERSION));
